      ...
      <div className="flex-1">
        ...
        <div className="flex items-baseline space-x-2 mt-1">
          <p className="text-2xl font-bold text-white">
            <CountUp
              end={parseInt(value.toString().replace(/,/g, ""))}
              duration={1.5}
              separator=","
            />
...
const SystemLoadGauge = () => {
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700">
      <h3 className="text-lg text-center font-semibold text-white mb-2">AI Engine Load</h3>
      <div className="relative">
        ...
        {/* Min/Max Labels */}
        <div className="absolute bottom-4 left-100 right-100 flex justify-between px-6 text-xs text-slate-400">
          <span>0%</span>
          <span>100%</span>
        </div>
      </div>
      ...
      <div className="bg-slate-900 text-white text-center">
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          <p className="mt-1 text-slate-400">
            Welcome back! Here's a real-time overview of your disaster response
            system.
          </p>
        </div>
      </div>
